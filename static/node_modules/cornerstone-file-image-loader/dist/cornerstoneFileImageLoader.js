...
exports.default = function (imageId, customObj) {
  // extract the attributes we need
  var rows = customObj.rows;
  var columns = customObj.columns;
...
exports.fileManager = exports.external = exports.configure = exports.loadImage = exports.createImage = exports.arrayBufferToImage = undefined;
...
var _fileManager = __webpack_require__(/*! ./fileManager.js */ "./fileManager.js");
...
var cornerstoneFileImageLoader = {
...
exports.default = cornerstoneFileImageLoader;
...
var _imageToImage = __webpack_require__(/*! ./imageToImage.js */ "./imageToImage.js");

var _imageToImage2 = _interopRequireDefault(_imageToImage);

var _canvasToImage = __webpack_require__(/*! ./canvasToImage.js */ "./canvasToImage.js");

var _canvasToImage2 = _interopRequireDefault(_canvasToImage);

var _dicomToImage = __webpack_require__(/*! ./dicomToImage.js */ "./dicomToImage.js");

var _dicomToImage2 = _interopRequireDefault(_dicomToImage);

var _createImage = __webpack_require__(/*! ./createImage.js */ "./createImage.js");

var _createImage2 = _interopRequireDefault(_createImage);

var _createImageCustom = __webpack_require__(/*! ./createImageCustom.js */ "./createImageCustom.js");

var _createImageCustom2 = _interopRequireDefault(_createImageCustom);

var _parseImageId = __webpack_require__(/*! ./parseImageId.js */ "./parseImageId.js");
  ...
  if (parsedImageId.scheme === 'imagefile') {
    ...
    var promise = new Promise(function (resolve, reject) {
      ...
      fileReader.onload = function (e) {
        var imageAsArrayBuffer = e.target.result;
        var imagePromise = (0, _arrayBufferToImage2.default)(imageAsArrayBuffer);
    ...
    var _promise2 = new Promise(function (resolve, reject) {
      if (file !== null && file !== undefined) {
        // file is an image
        var imagePromise = (0, _imageToImage2.default)(file);
        imagePromise.then(function (image) {
          var imageObject = (0, _createImage2.default)(image, imageId);
          resolve(imageObject);
        }, reject);
    ...
    var _promise3 = new Promise(function (resolve, reject) {
      if (file !== null && file !== undefined) {
        // file is a canvas
        var imagePromise = (0, _canvasToImage2.default)(file);
        imagePromise.then(function (image) {
          var imageObject = (0, _createImage2.default)(image, imageId);
          resolve(imageObject);
        }, reject);
    ...
    var _promise4 = new Promise(function (resolve, reject) {
      ...
      if (file !== null && file !== undefined) {
        // file is an custom object, with a cornerstone Image object and a pixelData array
        var imagePromise = (0, _createImageCustom2.default)(imageId, file);
        imagePromise.then(function (image) {
...
exports.default = function (cornerstone) {
  ...
  cornerstone.registerImageLoader('imagefile', _loadImage.loadImage);
  cornerstone.registerImageLoader('imagebuffer', _loadImage.loadImage);
  cornerstone.registerImageLoader('imageimage', _loadImage.loadImage);
  cornerstone.registerImageLoader('imagecanvas', _loadImage.loadImage);
  cornerstone.registerImageLoader('imagecustom', _loadImage.loadImage);
};
...
//# sourceMappingURL=cornerstoneFileImageLoader.js.map